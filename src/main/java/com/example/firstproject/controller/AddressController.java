...
public class AddressController {
    ...
    public ResponseEntity<List<AddressDTO>> getUserDetails(@RequestHeader("Authorization") String token) {
        List<AddressDTO> addressDTO = addressDetailsService.findByUserId(token);
